(function () {
  ...
  var MAP_GATE_KEYS = {
    ...
    intro: "mapGate.intro",
    accessEmailPlaceholder: "mapGate.accessEmailPlaceholder",
  ...
  function renderGate(configured) {
    ready(async function () {
      ...
      root.innerHTML = [
        ...
        '<form class="amg-form" id="amg-code-form"><input class="amg-input" name="email" type="email" autocomplete="email" placeholder="' + labels.accessEmailPlaceholder + '" required ' + (configured ? "" : "disabled") + '><input class="amg-input" name="code" type="password" autocomplete="one-time-code" placeholder="' + labels.codePlaceholder + '" required ' + (configured ? "" : "disabled") + '>',
      ...
      codeForm.addEventListener("submit", async function (event) {
        ...
        try {
          ...
          if (!codeForm.email.value) {
            codeForm.email.focus();
            codeForm.email.select();
          } else {
            codeForm.code.focus();
