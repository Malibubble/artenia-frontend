(function () {
  ...
  function addHeaderNav(root) {
    ...
    searchButton.className = mapAnchor.className;
    searchButton.textContent = "BUSCAR";
    searchButton.setAttribute("data-artenia-global-search-trigger", "header");
    searchButton.setAttribute("aria-label", "Abrir búsqueda ARTENIA");
    ...
    nav.insertBefore(searchButton, accessButton || null);
  ...
  function addMobileMenu(root) {
    ...
    for (var i = 0; i < mobileLinks.length; i += 1) {
      ...
      link.href = mobileLinks[i].action === "search" ? "#buscar" : mobileLinks[i].href;
      ...
      if (mobileLinks[i].action === "search") {
        link.setAttribute("data-artenia-global-search-trigger", "mobile");
        link.setAttribute("aria-label", "Abrir búsqueda ARTENIA");
      }
